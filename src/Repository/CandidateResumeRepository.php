...
/**
 * @extends ServiceEntityRepository<CandidateResume>
 *
...
class CandidateResumeRepository extends ServiceEntityRepository
{
    ...
    public function add(CandidateResume $entity, bool $flush = false): void
    {
    ...
    public function remove(CandidateResume $entity, bool $flush = false): void
    {
